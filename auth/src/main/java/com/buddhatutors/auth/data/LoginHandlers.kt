...
import com.buddhatutors.auth.domain.AuthLoginResult
...
data class OAuthCredentialImpl(val authCredential: AuthCredential) :
    com.buddhatutors.auth.domain.OAuthCredential
...
class FirebaseGoogleLoginHandler @Inject constructor(
    private val firebaseAuth: FirebaseAuth
) : com.buddhatutors.auth.domain.LoginHandler {
