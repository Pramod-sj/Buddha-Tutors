...
import com.buddhatutors.feature.admin.common.TutorItemCard
import com.buddhatutors.feature.admin.common.TutorItemCardPlaceholder
...
internal fun PreviewAdminHomePage() {
    MasterTutorHomeContent(
        ...
        uiEvent = {},
        tutorListingLazyPagingItems = flowOf(PagingData.empty<com.buddhatutors.model.tutorlisting.TutorListing>()).collectAsLazyPagingItems()
    )
}
        ...
        viewModel.effect.collect { uiEffect ->
            when (uiEffect) {
                ...
                is MasterTutorHomeUiEffect.NavigateToTutorVerificationScreen -> {
                    ...
                    navigateToTutorVerificationScreen(uiEffect.tutor)
                }
...
internal fun MasterTutorHomeContent(
    ...
    tutorListingLazyPagingItems: LazyPagingItems<com.buddhatutors.model.tutorlisting.TutorListing>
) {
