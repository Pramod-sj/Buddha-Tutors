...
internal sealed class TutorFilterUiEvent : UiEvent {
    ...
    data class SetDefaultFilters(val filterOption: FilterOption?) : TutorFilterUiEvent()
...
internal sealed class TutorFilterUiEffect : UiEffect {
    ...
    data class FilterApplied(val filterOption: FilterOption?) : TutorFilterUiEffect()
