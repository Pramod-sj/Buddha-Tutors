...
import com.buddhatutors.feature.student.slot_booking.slotbooking.TimeBlock
        ...
        TutorDetailScreenContent(
            ...
            TutorDetailUiState(
                ...
                tutorListing = com.buddhatutors.model.tutorlisting.TutorListing(
                    tutorUser = com.buddhatutors.model.user.User(
                        id = "Pramod",
                        name = "Pramod",
                        email = "",
                        userType = com.buddhatutors.model.user.UserType.TUTOR,
                    ), verification = com.buddhatutors.model.tutorlisting.Verification(
                        isApproved = false,
                        verifiedByUserId = "",
                        verifiedByUserName = "",
                        verifiedDateTime = ""
                    ...
                    expertiseIn = listOf(
                        com.buddhatutors.model.Topic("", "Story telling"),
                        com.buddhatutors.model.Topic("", "Story telling"),
                        com.buddhatutors.model.Topic("", "Story telling"),
                        com.buddhatutors.model.Topic("", "Story telling")
                    ),
    ...
    val getResult =
        rememberLauncherForActivityResult(ActivityResultContracts.StartIntentSenderForResult()) { activityResult ->
            if (activityResult.resultCode == 1) {
                viewModel.setEvent(
                    TutorDetailUiEvent.BookSlotButtonClick(WeakReference(activity))
                )
            }
        }
