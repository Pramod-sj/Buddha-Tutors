package com.buddhatutors.feature.student.home
...
import com.buddhatutors.feature.student.home.home.StudentHomeScreen
import com.buddhatutors.feature.student.home.session.MeetingSessionScreen
        ...
        Box(Modifier.padding(bottom = it.calculateBottomPadding())) {
            ...
            NavHost(
                ...
                composable(StudentBottomNavigationItems.Home.route) {
                    StudentHomeScreen(
                        openTutorDetailScreen = openTutorDetailScreen,
