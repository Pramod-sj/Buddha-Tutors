...
class CalendarEventBuilder @Inject constructor() {
    ...
    fun build(
        student: User,
        tutor: User,
        bookedSlot: com.buddhatutors.common.domain.model.tutorlisting.slotbooking.BookedSlot
    ): Event {
        return Event().apply {
...
internal class MeetingDataSourceImpl @Inject constructor(
...
) : com.buddhatutors.common.domain.datasource.MeetingDataSource {
        ...
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                com.buddhatutors.common.domain.model.Resource.Success(
                    com.buddhatutors.common.domain.model.meet.MeetInfo(
                ...
                e.printStackTrace()
                com.buddhatutors.common.domain.model.Resource.Error(e)
            }
        }
    ...
    override suspend fun cancelMeet(
        accessToken: String,
        eventId: String
    ): com.buddhatutors.common.domain.model.Resource<Unit> {
        return withContext(Dispatchers.IO) {
            val calendarService = calendarServiceFactory.create(accessToken)
            try {
                calendarService.events().delete(CALENDAR_ID, eventId).execute()
                com.buddhatutors.common.domain.model.Resource.Success(Unit)
            } catch (e: Exception) {
                e.printStackTrace()
                com.buddhatutors.common.domain.model.Resource.Error(e)
            }
